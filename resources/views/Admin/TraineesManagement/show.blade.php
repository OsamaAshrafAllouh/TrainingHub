                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row border-bottom pb-10">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">{{$trainee->gpa}}</td>
                                            </tr>
                                            <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                                <td class="border-top-0 pl-0 py-4 d-flex align-items-center">
                                            <span class="navi-icon mr-2">
                                            ...
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">
                                                   <span class="switch switch-primary">
                                                       <label>
                                                           <input type="checkbox" {{ $trainee->is_approved == 1 ? 'checked' : '' }} name="select"
                                                                  data-id="{{ $trainee->id }}">
                                                           <span></span>
                                                       </label>
                                                   </span>
                                ...
                                <div class="col-md-5 border-left-md pl-md-10 py-md-10 text-left">
                                    ...
                                    <div class="font-size-h6 font-weight-bold"><i class="fa fa-money-bill"></i>
                                        : {{$trainee->payment}}</div>
                                    <div class="font-size-h6 font-weight-bold mb-16">
                                    </div>
                                    <!--end::Total Amount-->
                                    <div class="border-bottom w-100 mb-16"></div>
                                    <!--begin::Invoice To-->
                        ...
                        <div class="col-md-9">
                            <div class="d-flex font-size-sm flex-wrap">
                                <button type="button" class="btn btn-primary font-weight-bolder py-4 mr-3 mr-sm-14 my-1"
                                        onclick="window.print();">Print Trainee Information
                                </button>
                                <a class="btn btn-dark font-weight-bolder ml-sm-auto my-1" href="{{ route('trainees.index') }}">Back</a>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('change', 'input[name="select"]', function () {
            var taineeId = $(this).data('id');
            var isChecked = $(this).prop('checked');

            // AJAX call to update advisor approval status
            $.ajax({
                url: '/sendemail/' + taineeId,
                type: 'GET',
                success: function (response) {
                    // Handle success response
                    if (isChecked) {
                        toastr.success('Trainee is now approved.');
                    } else {
                        toastr.warning('Trainee is now not approved.');
                    }
                },
