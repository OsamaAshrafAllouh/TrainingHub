                    ...
                    <div class="row justify-content-center pt-8 px-8 pt-md-27 px-md-0">
                        <div class="col-md-9">
                            <div class="rounded-xl overflow-hidden w-100 max-h-md-250px mb-30">
                                <img src="{{asset('admin/assets/media/bg/pg-invoices-5.png')}}" class="w-100" alt="">
                            </div>
                            <!--end: Invoice header-->
                            <!--begin: Invoice body-->
                            <div class="row border-bottom pb-10">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="text-left pt-7">{{$advisor->first_name}} {{$advisor->last_name}}</td>
                                            </tr>
                                            ...
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">{{$advisor->education}}</td>
                                            </tr>
                                            <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                                <td class="border-top-0 pl-0 py-4 d-flex align-items-center">
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">{{$advisor->address}}</td>
                                            </tr>
                                            <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                                <td class="border-top-0 pl-0 py-4 d-flex align-items-center">
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">{{$advisor->city}}</td>
                                            </tr>
                                            <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                                <td class="border-top-0 pl-0 py-4 d-flex align-items-center">
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">{{$advisor->language}}</td>
                                            </tr>
                                            ...
                                            <span class="navi-icon mr-2">
                                                ...
                                                <td class="border-top-0 text-left py-4">
                                                   <span class="switch switch-primary">
                                                       <label>
                                                           <input type="checkbox" {{ $advisor->is_approved == 1 ? 'checked' : '' }} name="select"
                                                                  data-id="{{ $advisor->id }}">
                                                           <span></span>
                                                       </label>
                                                   </span>
                                ...
                                <div class="col-md-5 border-left-md pl-md-10 py-md-10 text-left">
                                    ...
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3"> @if($advisor->cv)
                                    ...
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3">
                                        @if($advisor->certification)
                                            <a href="{{ $advisor->certification }}" class="btn btn-primary"
                                               target="_blank"
                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-28 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex font-size-sm flex-wrap">
                                ...
                                <a class="btn btn-dark font-weight-bolder ml-sm-auto my-1" href="{{ route('advisors.index') }}">Back</a>
